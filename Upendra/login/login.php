...
<title>buildmaster</title>
    ...
    <link rel="icon" href="/Buildmaster/resources/logo.png">
...
<head>
    <link rel="stylesheet" href="header.css">
        ...
        <div class="navbar">
            <div class="icon">
            <img class="logo_img" src="/Buildmaster/resources/logo.png">
        ...
        <img class="logo2" src="/Buildmaster/resources/logo.png">
        <div class="content">
